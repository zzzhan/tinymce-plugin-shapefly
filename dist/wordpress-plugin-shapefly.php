 ...
 * Plugin URI: http://github.com/zzzhan/tinymce-plugin-shapefly
 * Description: Insert read-make shapes online, such as rectangles and circles, arrows,, lines, flowchart symbols, and callouts.
 * Version: 0.1.0 
 * Author: zzzhan 
...
function shapefly_add_buttons( $plugin_array ) {
    $plugin_array['shapefly'] = plugins_url('tinymce.plugins.shapefly.js',__FILE__);
    return $plugin_array;
}
